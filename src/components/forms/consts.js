...
export const inputAgreementProps = [
    ...
    },
    {
        ...
        labelClass: " text-center col-10 col-sm-5 m-auto",
        icon: "fa-solid fa-dollar-sign",
        errorMessage: "Por favor, ingrese un valor de cuota inicial!!!",
    ...
    },
    {
        ...
        inputClass: "col-10 col-sm-5 m-auto my-3",
        labelClass: " text-center col-10 col-sm-5 m-auto",
        errorMessage: "Por favor, ingrese un número de cuotas!!!",
    ...
    },
    {
        ...
        labelClass: " text-center col-10 col-sm-5 m-auto",
        icon: "fa-solid fa-dollar-sign",
        errorMessage: "Por favor, ingrese un valor de cuota!!!",
